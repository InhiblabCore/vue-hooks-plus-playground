...
const initialPackages = [
  {
    ...
    url: 'https://unpkg.com/vue-hooks-plus/dist/js/index.es.js',
  },
  {
    name: '@vue-hooks-plus/use-request',
    source: 'unpkg',
    description: 'Vue hooks library use-request',
    url: 'https://unpkg.com/@vue-hooks-plus/use-request/dist/useRequest.es.js',
  },
  {
    name: '@vue-hooks-plus/use-immer',
    source: 'unpkg',
    description: 'Vue hooks library use-immer',
    url: 'https://unpkg.com/@vue-hooks-plus/use-immer/dist/useImmer.es.js',
  },
  {
    name: '@vue-hooks-plus/use-worker',
    source: 'unpkg',
    description: 'Vue hooks library use-worker',
    url: 'https://unpkg.com/@vue-hooks-plus/use-worker/dist/useWorker.es.js',
  }
]
